title <- "Cumulative human impacts: stressor data rescaled by two time periods (2008 and 2013, scaled from 0-1)"
creators <- data.frame(
...
the data and then dividing by the highest raster cell value observed across both the 2008 and 2013 data 
for each stressor.  There are N=15 2008 rasters (preceded by rescaled_2008_two_) and N=15 2013 rasters 
(preceded by rescaled_2013_two_).  There is no sea level rise raster for 2008."
