...
by the highest raster cell value observed across both the 2008 and 2013 data for each stressor. 
There are N=15 2008 rasters (preceeded by rescaled_2008_two_)
and N=15 2013 rasters (preceeded by rescaled_2013_two_).  There is no sea level rise raster for 2008."
